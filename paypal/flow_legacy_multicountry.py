...
class PayPalFlow:
    def __init__(
        ...
        self.browser_runtime = self.runtime_resolved.browser_engine
        self.continue_merchant = bool(self.runtime_resolved.continue_merchant)
        ...
        logger.info(
            "Runtime: profile={} mode={} engine={} fp={} dd={} mtr={} risk={} merchant={}",
            self.runtime_resolved.profile,
            self.runtime_mode,
            self.browser_runtime,
            self.runtime_resolved.fingerprint_source,
            self.runtime_resolved.datadome_mode,
            self.runtime_resolved.mtr_runtime,
            self.runtime_resolved.risk_signals_mode,
            self.continue_merchant,
        )
        try:
